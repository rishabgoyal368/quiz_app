...
<html lang="en" class="no-js">
	...
	<head>
		...
		<!-- END THEME STYLES -->
		<!-- <link href="{{ url('public/backEnd/css/datepicker.css') }}" rel="stylesheet" type="text/css"/> -->
		<!-- <link href="{{ url('public/backEnd/css/datepicker3.css') }}" rel="stylesheet" type="text/css"/>  -->
		<!-- <link rel="stylesheet" type="text/css" href="../../assets/global/plugins/bootstrap-datepicker/css/datepicker3.css"/> -->
		<!-- <link rel="stylesheet" type="text/css" href="../../assets/global/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css"/> -->
		<!-- <link rel="stylesheet" type="text/css" href="../../assets/global/plugins/bootstrap-colorpicker/css/colorpicker.css"/> -->
		<!-- <link rel="stylesheet" type="text/css" href="{{ url('public/backEnd/css/daterangepicker-bs3.css') }}"/>
		<link rel="stylesheet" type="text/css" href="{{ url('public/backEnd/css/bootstrap-datetimepicker.min.css') }}"/> -->

		<!-- data-table start -->
		<link rel="stylesheet" type="text/css" href="{{ url(backEndCssPath.'/select2.css') }}"/>
		<link rel="stylesheet" type="text/css" href="{{ url(backEndCssPath.'/dataTables.scroller.min.css') }}"/>
		<link rel="stylesheet" type="text/css" href="{{ url(backEndCssPath.'/dataTables.colReorder.min.css') }}"/>
		<link rel="stylesheet" type="text/css" href="{{ url(backEndCssPath.'/dataTables.bootstrap.css') }}"/>
		<!-- data-table end -->
	...
	<body class="page-header-fixed page-quick-sidebar-over-content">
		...
		<div class="page-footer">
			<div class="page-footer-inner">
				Copyright © Laravel 8 <?php echo date('Y'); ?>. All Rights Reserved.
			</div>
		...
		<!-- data table - ajax -->
		<script type="text/javascript" src="{{ url('public/backEnd/js/jquery.dataTables.min.js') }}"></script>
		<script type="text/javascript" src="{{ url('public/backEnd/js/dataTables.tableTools.min.js') }}"></script>
		<script type="text/javascript" src="{{ url('public/backEnd/js/dataTables.colReorder.min.js') }}"></script>
		<script type="text/javascript" src="{{ url('public/backEnd/js/dataTables.scroller.min.js') }}"></script>
		<script type="text/javascript" src="{{ url('public/backEnd/js/dataTables.bootstrap.js') }}"></script>
		<script src="{{ url('public/backEnd/js/demo.js') }}" type="text/javascript"></script>
		<script src="{{ url(backEndJsPath.'/datatable.js') }}"  type="text/javascript"></script>
		<script src="{{ url(backEndJsPath.'/table-ajax.js') }}"  type="text/javascript"></script>
        <!-- data-tables end -->
